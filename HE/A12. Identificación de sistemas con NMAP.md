...
```
<img width="1918" height="676" alt="Captura de pantalla 2026-02-11 130417" src="https://github.com/user-attachments/assets/a07cd4f1-d8b9-4385-8486-bbf7c1191644" />

e) Comprueba si existen usuarios con contraseñas vacías (NSE).
```bash
nmap --script auth -p 21,22,445,3306 192.168.56.101
```
<img width="875" height="669" alt="Captura de pantalla 2026-02-11 130530" src="https://github.com/user-attachments/assets/6a7a7409-d958-407d-b664-eb2feb1877d4" />
